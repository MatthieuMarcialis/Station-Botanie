...
static const u4_t DEVADDR = 0x260B888F;

// LoRaWAN NwkSKey, network session key
// This is the default Semtech key, which is used by the early prototype TTN
// network.
static const PROGMEM u1_t NWKSKEY[16] = {  0x5A, 0x17, 0x1E, 0x60, 0x09, 0xB6, 0xC2, 0x19, 0xC7, 0xC2, 0x50, 0x77, 0x5C, 0x48, 0xCE, 0x21 };


// LoRaWAN AppSKey, application session key
// This is the default Semtech key, which is used by the early prototype TTN
// network.
static const u1_t PROGMEM APPSKEY[16] = {  0xD1, 0xFC, 0xFE, 0x33, 0x0B, 0xDB, 0xF7, 0xC9, 0x7F, 0x49, 0x59, 0x20, 0x66, 0x18, 0xE4, 0x39 };
...
void setup() {
    ...
    // Set up external humidity sensor
    pinMode(2, OUTPUT);
    pinMode(A2, INPUT);
    digitalWrite(2, HIGH);
